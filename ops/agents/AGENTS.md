...
Use feature branches and PR review. No direct main pushes, no manual runtime editing, no self-approval. Do not commit or push this Phase 0 change until the owner approves. Never include secrets in Git, prompts, logs or handoffs. Reference secret names only; do not read or print credential values.
