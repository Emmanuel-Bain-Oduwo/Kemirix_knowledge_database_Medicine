...
1. Human approves/integrates the foundation and records the latest approved develop SHA in the prepared task. Provision worktrees, access separation and provider credentials through the operator workflow.
